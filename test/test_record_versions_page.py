...
class TestRecordVersionsPage(unittest.TestCase):
    """RecordVersionsPage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RecordVersionsPage:
        """Test RecordVersionsPage
            include_option is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RecordVersionsPage`
        """
        model = RecordVersionsPage()
        if include_optional:
            return RecordVersionsPage(
                next_page_token = '',
                records = [
                    grax.models.record.Record(
    ...
    def testRecordVersionsPage(self):
        """Test RecordVersionsPage"""
