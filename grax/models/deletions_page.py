...
class DeletionsPage(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["deletions", "nextPageToken"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "deletions": [Deletion.from_dict(_item) for _item in obj["deletions"]] if obj.get("deletions") is not None else None,
