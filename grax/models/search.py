...
class Search(BaseModel):
    ...
    started: Optional[datetime] = Field(default=None, description="Time the search job was started.")
    status: Optional[StrictStr] = Field(default=None, description="Status of the search job. Can be 'pending', 'started', 'success', 'error' or 'aborted'.")
