...
class SearchesPage(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["nextPageToken", "searches"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "searches": [Search.from_dict(_item) for _item in obj["searches"]] if obj.get("searches") is not None else None
        })
        return _obj
