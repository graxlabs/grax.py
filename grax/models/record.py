...
class Record(BaseModel):
    ...
    object: Optional[StrictStr] = Field(default=None, description="Object name.")
    ...
    __properties: ClassVar[List[str]] = ["deleted", "fields", "id", "modified", "name", "object", "purged", "restoredFrom", "salesforceURL"]
