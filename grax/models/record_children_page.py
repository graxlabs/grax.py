...
class RecordChildrenPage(BaseModel):
    """
    RecordChildrenPage
    """ # noqa: E501
    ...
    records: Optional[List[ChildRecord]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "records": [ChildRecord.from_dict(_item) for _item in obj["records"]] if obj.get("records") is not None else None
        })
        return _obj
