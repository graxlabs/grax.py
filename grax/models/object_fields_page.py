...
class ObjectFieldsPage(BaseModel):
    """
    ObjectFieldsPage
    """ # noqa: E501
    fields: Optional[List[ObjectField]] = Field(default=None, description="Fields.")
    ...
    __properties: ClassVar[List[str]] = ["fields", "nextPageToken"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "fields": [ObjectField.from_dict(_item) for _item in obj["fields"]] if obj.get("fields") is not None else None,
