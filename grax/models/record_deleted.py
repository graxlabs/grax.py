...
class RecordDeleted(BaseModel):
    ...
    RecordDeleted
    """ # noqa: E501
    activity_id: Optional[StrictStr] = Field(default=None, description="Activity ID that deleted the record.", alias="activityID")
    source: Optional[StrictStr] = Field(default=None, description="Source of the delete.")
    time: Optional[datetime] = Field(default=None, description="Time the record was deleted.")
    user: Optional[AuditUser] = None
    __properties: ClassVar[List[str]] = ["activityID", "source", "time", "user"]
    ...
    def source_validate_enum(cls, value):
        ...
        if value not in set(['grax', 'salesforce']):
            raise ValueError("must be one of enum values ('grax', 'salesforce')")
        return value
